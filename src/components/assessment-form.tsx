...
export function AssessmentForm() {
  ...
  async function saveAssessment() {
    ...
    try {
      const response = await fetch("/api/assessments", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ ...input, rainfallSource: provenance.source, rainfallDataPeriod: provenance.period, rainfallRetrievedAt: provenance.retrievedAt }) });
      const data = await response.json();
