...
const input = z.object({
  city: z.string().min(2), roofAreaSqFt: z.number().min(20), roofType: z.enum(["concrete", "metal", "tiles"]), annualRainfallMm: z.number().min(100), occupants: z.number().int().min(1),
