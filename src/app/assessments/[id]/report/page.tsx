...
export default async function AssessmentReportPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="report-page">
    ...
    <article className="report-sheet">
      <header><p className="eyebrow"><span data-no-translate>NEERPLAN</span> · ASSESSMENT REPORT</p><h1>Rooftop rainwater potential</h1><p><span>{assessment.city}</span> · prepared {new Intl.DateTimeFormat("en-IN", { dateStyle: "long" }).format(assessment.createdAt)}</p></header>
